...
class Branch(db.Model):
    ...
    transactions = db.relationship("Transaction", back_populates="branch")
...
class Transaction(db.Model):
    ...
    selected_by_id = db.Column(db.Integer, db.ForeignKey("employees.id"), nullable=True)
    ...
    alerts = db.relationship("Alert", back_populates="transaction")
